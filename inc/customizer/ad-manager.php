...
if ( get_theme_mod('ads_posts') || get_theme_mod('ads_pages') ) {
    ...
    if ( get_theme_mod('ad_code_post_middle') ) {
        add_filter('the_content', 'mtblog_insert_ads_middle');
        function mtblog_insert_ads_middle($content) {
            ...
            if( get_theme_mod('ads_posts') ) {
                if (is_single() && ! is_admin()) {
                    return mtblog_insert_after_paragraphs($content, $insertion, array($middleParagraph));
                }
            }
    ...
    if ( get_theme_mod('ad_before_last_paragraph') ) {
        add_filter('the_content', 'mtblog_insert_ads_before_last');
        
        function mtblog_insert_ads_before_last($content) {
            ...
            if( get_theme_mod('ads_posts') ) {
                if (is_single() && ! is_admin()) {
                    return mtblog_insert_after_paragraphs($content, $insertion, array($lastParagraph));
                }
            }
    ...
    if ( get_theme_mod('paragraph_number') && get_theme_mod('ad_after_numbered_paragraph')) {
        add_filter('the_content', 'mtblog_insert_ads_after_number');
        function mtblog_insert_ads_after_number($content) {
            ...
            if( get_theme_mod('ads_posts') ) {
                if (is_single() && ! is_admin()) {
                    return mtblog_insert_after_paragraphs($content, $insertion, array($paragraphNumber));
                }
            }
    ...
    function mtblog_insert_after_paragraphs($content, $insertion, $paragraph_indexes) {
